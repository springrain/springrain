...
public class UserPlatformInfos  extends BaseEntity {
	...
	//alias
	/*
	public static final String TABLE_ALIAS = "UserPlatformInfos";
	public static final String ALIAS_ID = "id";
	public static final String ALIAS_OPENID = "公众号openId,企业号userId,小程序openId,APP推送deviceToken";
	public static final String ALIAS_DEVICETYPE = "设备/应用类型：1公众号2小程序3企业号4APP消息推送";
	public static final String ALIAS_SITEID = "所属站点ID";
	public static final String ALIAS_USERID = "t_user表中ID";
    ...
    */
	...
	public String toString() {
		return new StringBuilder()
			...
			.append("设备/应用类型：1公众号2小程序3企业号4APP消息推送[").append(getDeviceType()).append("],")
			.append("所属站点ID[").append(getSiteId()).append("],")
			.append("t_user表中ID[").append(getUserId()).append("],")

...
public class ShiroConfig {
	 ...
	 * 
	 * @Bean("shiroCacheManager") public CacheManager shiroCacheManager() {
	 * ShiroRedisCacheManager cacheManager=new ShiroRedisCacheManager();
	 * cacheManager.setRedissonClient(redissonClient); return cacheManager; }
	 * 
	 */
	...
	/**
	 * 更新 shiroFilter的根拦截器,具体实现是
	 * org.apache.shiro.spring.web.ShiroFilterFactoryBean.SpringShiroFilter,使用AbstractShiroFilter类型
	 * 
	 * @param filter
	 * @return
	 */

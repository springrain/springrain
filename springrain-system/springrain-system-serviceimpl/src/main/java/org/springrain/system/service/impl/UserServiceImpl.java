...
public class UserServiceImpl extends BaseSpringrainServiceImpl implements IUserService {
    ...
    public List<User> findUserList(Page<User> page) throws Exception {
        ...
        if (queryBean != null) {
            ...
            if (StringUtils.isBlank(deptId)) {
                List<String> orgIdByUserId = userRoleOrgService.findOrgIdByUserId(SessionUser.getUserId(), null);
                if (CollectionUtils.isNotEmpty(orgIdByUserId)) {
                    deptId = orgIdByUserId.get(0);
                }
            }
    ...
    public void saveByImported(String path) throws Exception {
        ...
        while (iterator.hasNext()) {
            ...
            Date createTime = DateUtils.convertString2Date(DateUtils.DATETIME_FORMAT, cell.toString());
    ...
    public List<User> findUsers() throws Exception {
        ...
        return super.queryForList(selectFinder, User.class);
    }

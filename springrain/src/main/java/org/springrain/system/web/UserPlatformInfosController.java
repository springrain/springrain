...
public class UserPlatformInfosController  extends BaseController {
	 ...
	 */
	@RequestMapping("/list")
	public String list(HttpServletRequest request, Model model,UserPlatformInfos userPlatformInfos) 
			throws Exception {
	...
	@ResponseBody   
	public  ReturnDatas listjson(HttpServletRequest request, Model model,UserPlatformInfos userPlatformInfos) throws Exception{
	...
	public void listexport(HttpServletRequest request,HttpServletResponse response, Model model,UserPlatformInfos userPlatformInfos) throws Exception{
		// ==构造分页请求
		Page page = newPage(request);
	
		File file = userPlatformInfosService.findDataExportExcel(null,listurl, page,UserPlatformInfos.class,userPlatformInfos);
	...
	@ResponseBody      
	public ReturnDatas saveorupdate(Model model,UserPlatformInfos userPlatformInfos,HttpServletRequest request,HttpServletResponse response) throws Exception{
		ReturnDatas returnObject = ReturnDatas.getSuccessReturnDatas();

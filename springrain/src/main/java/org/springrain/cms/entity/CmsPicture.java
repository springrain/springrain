...
public class CmsPicture  extends BaseEntity {
	...
	public static final String ALIAS_PICTUREURL = "网络路径";
	public static final String ALIAS_MIDDLEPICTUREURL = "middlePictureUrl";
    ...
    */
	...
	public String toString() {
		return new StringBuffer()
			...
			.append("网络路径[").append(getPictureUrl()).append("],")
			.append("middlePictureUrl[").append(getMiddlePictureUrl()).append("],")

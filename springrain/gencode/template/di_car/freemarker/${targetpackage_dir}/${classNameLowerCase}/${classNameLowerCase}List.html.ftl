				...
				<ul class="layui-tab-title site-demo-title">
					 ...
					 <li style="float:right;">
		             	${r"<@shiro.hasPermission"} name="/${classNameLowerCase}/update" >
		             		<button type="button"  style="margin-top:8px;" class="layui-btn layui-btn-small" data-action="${r"${ctx}"}/${classNameLowerCase}/update/pre"><i class="layui-icon layui-icon-specil">&#xe61f;</i>新增</button>
		             	${r"</@shiro.hasPermission>"}
		             	${r"<@shiro.hasPermission"} name="/${classNameLowerCase}/list/export" >
				        	<button type="button"  style="margin-top:8px;" class="layui-btn layui-btn-small"><i class="layui-icon layui-icon-specil">&#xe609;</i>导出</button>
				        ${r"</@shiro.hasPermission>"}
		                <button type="button"  style="margin-top:8px;" class="layui-btn layui-btn-warm layui-btn-small"><i class="layui-icon layui-icon-specil">&#xe601;</i>导入</button>
		                ${r"<@shiro.hasPermission"} name="/${classNameLowerCase}/delete" >
		               		 <button type="button"  style="margin-top:8px;" class="layui-btn layui-btn-danger layui-btn-small"><i class="layui-icon">&#xe640;</i>批量删除</button>
		                ${r"</@shiro.hasPermission>"}
		             </li>
	       		</ul>

...
import org.iu9.testdb1.service.ITsubsystemService;
 ...
 * @see org.iu9.testdb1.service.impl.Tsubsystem
 */
@Service("tsubsystemService")
public class TsubsystemServiceImpl extends BaseTestdb1ServiceImpl implements ITsubsystemService {

   
    @Override
	public String  saveTsubsystem(Tsubsystem entity) throws Exception{
	       return super.save(entity).toString();
	}

    @Override
	public String  saveorupdateTsubsystem(Tsubsystem entity) throws Exception{
	       return super.saveorupdate(entity).toString();
	}
	
	@Override
    public Integer updateTsubsystem(Tsubsystem entity) throws Exception{
	return super.update(entity);
    }
    @Override
	public Tsubsystem findTsubsystemById(Object id) throws Exception{
	 return super.findById(id,Tsubsystem.class);
	}

...
import org.iu9.testdb1.service.ITroleMenuService;
 ...
 * @see org.iu9.testdb1.service.impl.TroleMenu
 */
@Service("troleMenuService")
public class TroleMenuServiceImpl extends BaseTestdb1ServiceImpl implements ITroleMenuService {

   
    @Override
	public String  saveTroleMenu(TroleMenu entity) throws Exception{
	       return super.save(entity).toString();
	}

    @Override
	public String  saveorupdateTroleMenu(TroleMenu entity) throws Exception{
	       return super.saveorupdate(entity).toString();
	}
	
	@Override
    public Integer updateTroleMenu(TroleMenu entity) throws Exception{
	return super.update(entity);
    }
    @Override
	public TroleMenu findTroleMenuById(Object id) throws Exception{
	 return super.findById(id,TroleMenu.class);
	}

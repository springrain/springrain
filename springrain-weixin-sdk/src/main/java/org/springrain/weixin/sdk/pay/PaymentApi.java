...
public class PaymentApi {
    ...
    private static Map<String, String> request(String url, Map<String, String> params, String paternerKey) {
        ...
        String xmlStr = HttpClientUtils.sendHttpPost(url, PaymentKit.toXml(params));
    ...
    public static Map<String, String> refund(IWxMpConfig wxmpconfig,Map<String, String> params, String paternerKey, String certPath) {
        ...
        String xmlStr = HttpClientUtils.sendHttpPostSSL(refundUrl, PaymentKit.toXml(params), certPath, partner);
        return PaymentKit.xmlToMap(xmlStr);
    }
    ...
    public static String downloadBill(IWxMpConfig wxmpconfig,String appid, String mch_id, String paternerKey, String billDate, BillType billType) {
        ...
        String sign = PaymentKit.createSign(params, paternerKey);
        params.put("sign", sign);
        return HttpClientUtils.sendHttpPost(downloadBillUrl, PaymentKit.toXml(params));
    }

...
public class CardFriendCouponApi {
    ...
    public static ApiResult getPayPrice(IWxMpConfig wxmpconfig, String cardId, int quantity) {
        ...
        String jsonResult = HttpClientUtils.sendPostUploadFiles(getPayPriceUrl + wxmpconfig.getAccessToken(), JsonUtils.writeValueAsString(data));
        return new ApiResult(jsonResult);
    }
    ...
    public static ApiResult confirm(IWxMpConfig wxmpconfig, String cardId, int quantity, String orderId) {
        ...
        String jsonResult = HttpClientUtils.sendPostUploadFiles(confirmUrl + wxmpconfig.getAccessToken(), JsonUtils.writeValueAsString(data));
        return new ApiResult(jsonResult);
    }
    ...
    public static ApiResult recharge(IWxMpConfig wxmpconfig, int coinCount) {
        ...
        String jsonResult = HttpClientUtils.sendPostUploadFiles(rechargeUrl + wxmpconfig.getAccessToken(), JsonUtils.writeValueAsString(data));
        return new ApiResult(jsonResult);
    }
    ...
    public static ApiResult getOrder(IWxMpConfig wxmpconfig, String orderId) {
        Map<String, Object> data = new HashMap<>();
        data.put("order_id", orderId);
        String jsonResult = HttpClientUtils.sendPostUploadFiles(getOrderUrl + wxmpconfig.getAccessToken(), JsonUtils.writeValueAsString(data));
        return new ApiResult(jsonResult);
    }
    ...
    public static ApiResult getOrderList(IWxMpConfig wxmpconfig, String jsonStr) {
        String jsonResult = HttpClientUtils.sendPostUploadFiles(getOrderListUrl + wxmpconfig.getAccessToken(), jsonStr);
        return new ApiResult(jsonResult);
    }
}

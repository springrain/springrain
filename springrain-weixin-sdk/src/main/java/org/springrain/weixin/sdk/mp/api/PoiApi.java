...
public class PoiApi {
    ...
    public static ApiResult addPoi(Poi poi) {
        ...
        return addPoi(JsonUtils.writeValueAsString(business));
    }
    ...
    public static ApiResult getCategory() {
        ParaMap pm = ParaMap.create("access_token", wxmpconfig.getAccessToken());
        return new ApiResult(HttpClientUtils.sendHttpGet(getWxCategory, pm.getData()));
    }
}
